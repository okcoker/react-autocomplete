...
var Autocomplete = React.createClass({
  ...
  propTypes: {
    ...
    /**
     * Disables range selection of input value. Useful for fixing mobile situations
     * where the keyboard acts strangely with range selection
     */
    disableSelectionRange: React.PropTypes.bool,
    /**
    ...
    Enter: function Enter(event) {
      ...
      if (this.state.isOpen === false) {
        ...
        this.setState({
          ...
          if (!_this.props.disableSelectionRange) {
